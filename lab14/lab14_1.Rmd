...
```{r}
ggmap(map1) +
  geom_point(data=spiders, aes(longitude, latitude), size=1, color="black", alpha=0.8)+
...
```{r}
ggmap(map2) +
  geom_point(data=grizzly, aes(longitude, latitude), size=1, color="black", alpha=0.8)+
  labs(x="Longitude", y="Latitude", title="Alaska Bears")
```
